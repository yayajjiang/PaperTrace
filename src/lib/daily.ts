...
export const dailyPapers: DailyPaper[] = [
  ...
  {
    date: "2026-08-23",
    title: "iLLaDA: Improved Large Language Diffusion Models",
    titleZh: "iLLaDA：改进型大语言扩散模型",
    authors: "Shen Nie et al.",
    arxivId: "2606.25331",
    tags: ["Diffusion LM", "Pre-training"],
    why: "8B masked diffusion LM trained on 12T tokens: +21.6 pts on BBH, +14.9 pts on ARC-Challenge vs LLaDA — competitive with Qwen2.5 7B. NeurIPS 2026.",
    whyZh: "8B掩码扩散LM，12T token训练，BBH提升21.6分，ARC-Challenge提升14.9分，与Qwen2.5 7B相当，NeurIPS 2026。",
    pick: true,
  },
  {
    date: "2026-08-23",
