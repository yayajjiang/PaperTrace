...
export const dailyPapers: DailyPaper[] = [
  {
    ...
    authors: "Intern-NCP Team et al.",
    arxivId: "2609.10715",
    tags: ["Pre-training", "Theory"],
    why: "Jointly trains LMs on next-token and next-concept prediction — discrete multi-token abstractions in a product-quantized latent space push pretraining beyond token-level thinking. #1 HuggingFace trending this week.",
    whyZh: "联合训练NTP与NCP双目标，在乘积量化潜空间预测多token概念单元，本周HuggingFace热榜第一，拓展预训练新范式。",
    pick: true,
  },
  {
    date: "2026-09-13",
    ...
    why: "Ψ-Spec samplers give any AR LLM diffusion-based parallel generation — 8B Uno achieves 3× lossless speedup, outperforming Mercury 2 and leading open diffusion LLMs on agentic coding benchmarks.",
    whyZh: "Ψ-Spec采样器为自回归LLM引入扩散并行解码，8B Uno实现3倍无损加速，超越Mercury 2与主流开源扩散LLM。",
    pick: true,
  },
  {
    date: "2026-09-13",
    ...
    why: "Finds alignment collapse in large reasoning models: longer thinking chains amplify safety regressions. Introduces ALR metric and mitigation strategies for safer reasoning scaling.",
    whyZh: "揭示大型推理模型的对齐坍塌：推理越深安全退化越严重，提出ALR指标与缓解策略，推动更安全的推理扩展。",
    pick: true,
  },
  {
    date: "2026-09-13",
    ...
    why: "Co-designs speculative decoding with DVFS hardware control for on-device LLMs — 23.1% speedup and 52.4% energy reduction, extending battery life for edge inference.",
    whyZh: "推测解码与动态电压频率调节硬件协同设计，端侧LLM加速23.1%、能耗降低52.4%，大幅延长边缘设备续航。",
  },
  {
    date: "2026-09-13",
    ...
    why: "15K synthetic block-stacking problems teach LVLMs 3D-to-2D projection and viewpoint reasoning — cheap verifiable spatial supervision with strong transfer to real spatial benchmarks.",
    whyZh: "15K合成积木堆叠问题训练多模态LLM的空间推理能力，可验证监督信号在真实空间基准迁移效果显著。",
  },
  {
    date: "2026-09-06",
