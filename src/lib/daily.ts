...
export const dailyPapers: DailyPaper[] = [
  ...
  },
  {
    ...
    authors: "Liting Zhang et al.",
    arxivId: "2606.05859",
    tags: ["Reasoning", "RLHF"],
    why: "Per-token router adaptively switches between discrete vocabulary and continuous latent reasoning; GRPO joint training improves Pass@32 by 1.22% while cutting token usage 15% across Qwen2.5 and Llama backbones.",
    whyZh: "逐Token路由器在离散词汇与连续潜在推理间自适应切换，GRPO联合优化使Pass@32提升1.22%同时token用量减少15%。",
    pick: true,
  },
  {
    date: "2026-08-09",
