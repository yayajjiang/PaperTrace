...
export const dailyPapers: DailyPaper[] = [
  ...
  },
  {
    ...
    titleZh: "TIDE：基于I/O感知专家卸载的高效无损MoE扩散LLM推理",
    authors: "Zhiben Chen et al.",
    arxivId: "2605.20179",
    tags: ["MoE", "Diffusion LM", "Efficient Inference"],
    why: "I/O-aware expert offloading exploits temporal stability of MoE activations across diffusion steps — lossless MoE diffusion LLM inference on memory-limited hardware.",
    whyZh: "利用扩散步骤间MoE激活的时序稳定性进行I/O感知专家卸载，在内存受限设备上实现无损MoE扩散LLM推理。",
  },
  {
    date: "2026-05-31",
    title: "The Unlearnability Phenomenon in RLVR for Language Models",
    titleZh: "语言模型RLVR训练中的不可学习性现象",
    authors: "Yulin Chen et al.",
    arxivId: "2605.16787",
    tags: ["Reasoning", "Theory"],
    why: "Reveals a substantial fraction of hard RLVR examples are fundamentally unlearnable — low gradient similarity and non-generalizable patterns persist despite data augmentation.",
    whyZh: "揭示相当比例的困难样本对RLVR根本不可学习，低梯度相似性和不可泛化推理模式无法通过数据增强解决。",
  },
  {
    date: "2026-05-31",
