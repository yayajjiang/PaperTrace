...
export const dailyPapers: DailyPaper[] = [
  {
    ...
    why: "Coupled-noise distillation trains a student to commit a full block in one forward pass — eliminates per-position iterative refinement in masked diffusion LMs. EMNLP 2026 main.",
    whyZh: "联合噪声蒸馏训练学生单次前向传播提交整块token，消除扩散LM逐位置迭代去噪，EMNLP 2026主会录用。",
    pick: true,
  },
  {
    date: "2026-09-20",
    ...
    why: "Declarative Attention embeds attention-scope annotations in chain-of-thought; inference engine skips irrelevant KV-cache reads without retraining — practical latency gains on long contexts.",
    whyZh: "声明式注意力在生成时嵌入范围声明，推理引擎跳过无关KV缓存读取，无需重训即可降低长上下文推理延迟。",
    pick: true,
  },
  {
    date: "2026-09-20",
    title: "BASIS: Batchwise Advantage Estimation from Single-Rollout Information Sharing for LLM Reasoning",
    titleZh: "BASIS：单次Rollout批量信息共享的LLM推理优势估计",
    authors: "Anonymous et al.",
    arxivId: "2605.27293",
    tags: ["Reasoning", "RLHF"],
    why: "Cross-prompt batch information sharing cuts RL value estimation MSE by 69% with one rollout per prompt — outperforms 8-sample group mean at lower compute. EMNLP 2026.",
    whyZh: "跨提示批量共享单次rollout信息，优势估计MSE降低69%，优于8组均值基线，大幅降低RL训练开销，EMNLP 2026录用。",
    pick: true,
  },
  {
    date: "2026-09-20",
    ...
    arxivId: "2609.02108",
    tags: ["Diffusion LM", "Efficient Inference"],
    why: "PILL predicts infill length from a single mask-token hidden state — variable-length infilling in fixed-length DLMs in two passes: +4.8 pp code pass rate, 1.82× faster. EMNLP 2026.",
    whyZh: "PILL用单掩码token隐状态预测填充长度，两次前向传播实现变长填充，代码pass率提升4.8%，速度1.82倍，EMNLP 2026录用。",
  },
  {
    date: "2026-09-20",
    ...
    authors: "Yixiang Liu et al.",
    arxivId: "2609.11315",
    tags: ["Diffusion LM", "Multimodal"],
    why: "Training-free trajectory controller routes LLaDA-V queries to early-commit or reasoning-extended decoding — fixes universal-length mismatch in diffusion VLMs. Findings EMNLP 2026.",
    whyZh: "训练无关控制器依轨迹信号路由LLaDA-V问题至早提交或推理增强解码，解决扩散VLM通用长度错配，Findings EMNLP 2026。",
  },
  {
    date: "2026-09-20",
    title: "Coupled Calibration and Learning: Mitigating Teacher Bias in LLM Distillation without Target-Domain Reward Feedback",
    titleZh: "耦合校准与学习：免目标域奖励反馈的LLM蒸馏去偏",
    authors: "Haichen Hu et al.",
    arxivId: "2609.17474",
    tags: ["Fine-tuning"],
    why: "CCL iteratively calibrates teacher on source-domain rewards then trains student on target — overcomes teacher bias without target-domain supervision, with theoretical recovery guarantee.",
    whyZh: "CCL迭代校准教师在源域奖励上的偏差并训练学生于目标域，无需目标域奖励反馈，理论上保证收敛至最优学生模型。",
  },
  {
    date: "2026-09-06",
