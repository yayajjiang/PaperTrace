...
export const dailyPapers: DailyPaper[] = [
  {
    ...
    titleZh: "改进大语言扩散模型（iLLaDA）",
    authors: "iLLaDA Team et al.",
    arxivId: "2606.25331",
    tags: ["Diffusion LM", "Pre-training"],
    why: "8B masked diffusion LM on 12T tokens: +21.6 BBH and +14.5 MATH over LLaDA, competitive with Qwen2.5-7B — bidirectional diffusion scales.",
    whyZh: "8B掩码扩散LM训练于12T token，BBH提升21.6分、MATH提升14.5分超越LLaDA，与Qwen2.5-7B持平，双向扩散可规模化。",
    pick: true,
  },
  {
    date: "2026-07-19",
