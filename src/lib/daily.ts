...
export const dailyPapers: DailyPaper[] = [
  {
    ...
    titleZh: "重新思考LLM推理中的强化学习：稀疏策略选择而非能力习得",
    authors: "Akgül et al.",
    arxivId: "2605.06241",
    tags: ["Reasoning", "RLHF", "Theory"],
    why: "RL doesn't teach new reasoning skills — it sparsely adjusts probabilities at high-entropy branch points. Only 1–3% of tokens are affected, always within the base model's top-5 alternatives.",
    whyZh: "RL不教推理新技巧，仅在1-3%高熵决策点稀疏调整概率，总在基础模型top-5候选内，从根本上重构了对RL后训练的认知。",
    pick: true,
  },
  {
    date: "2026-05-10",
    title: "Can RL Teach Long-Horizon Reasoning to LLMs? Expressiveness Is Key",
    titleZh: "强化学习能否教会LLM长程推理？表达能力是关键",
    authors: "Tianle Wang et al.",
    arxivId: "2605.06638",
    tags: ["Reasoning", "Theory"],
    why: "ScaleLogic disentangles proof depth from logical expressiveness — RL compute scales as power law with depth but the exponent (1.04→2.60) is set by expressiveness, not depth alone.",
    whyZh: "ScaleLogic分离推理深度与逻辑表达力：RL算力随深度幂律增长，但指数由表达力决定（1.04→2.60），与深度无关。",
  },
  {
    date: "2026-05-10",
