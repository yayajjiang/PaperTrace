...
export const dailyPapers: DailyPaper[] = [
  {
    date: "2026-07-05",
    title: "Improved Large Language Diffusion Models (iLLaDA)",
    titleZh: "改进的大型语言扩散模型（iLLaDA）",
    authors: "iLLaDA Team et al.",
    arxivId: "2606.25331",
    tags: ["Diffusion LM", "Pre-training"],
    why: "8B masked diffusion LM trained from scratch with fully bidirectional attention — +21.6 pts BBH, +14.9 pts ARC-Challenge over LLaDA, substantially closing the gap with autoregressive models.",
    whyZh: "从头训练8B全双向注意力掩码扩散LM，BBH提升21.6分、ARC-Challenge提升14.9分，大幅缩小与自回归模型的质量差距。",
    pick: true,
  },
  {
    date: "2026-07-05",
