...
export const dailyPapers: DailyPaper[] = [
  ...
  },
  {
    ...
    titleZh: "KARA：基于滑动窗口KV缓存压缩的高效推理LLM服务",
    authors: "Han Shen et al.",
    arxivId: "2607.01237",
    tags: ["Efficient Inference", "Reasoning"],
    why: "Sliding-window bidirectional attention selects informative KV pairs at decode time — preserves ~100% full-KV accuracy retaining only 20% of cache; solves memory bottleneck for long CoT serving.",
    whyZh: "滑动窗口双向注意力在解码时动态筛选重要KV对，仅保留20%缓存即可维持接近完整KV精度，有效解决长链推理LLM的显存瓶颈。",
    pick: true,
  },
  {
    date: "2026-07-26",
