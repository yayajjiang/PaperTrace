...
export const dailyPapers: DailyPaper[] = [
  ...
  },
  {
    ...
    titleZh: "Sangam：基于AR框架高效部署扩散LLM",
    authors: "Nitin Kedia et al.",
    arxivId: "2607.04206",
    tags: ["Diffusion LM", "Efficient Inference"],
    why: "First serving system for diffusion LLMs — deficit token-budget scheduler resolves KV-cache incompatibility from bidirectional attention, benchmarked across colocated and disaggregated modes.",
    whyZh: "首个扩散LLM生产级服务系统，赤字token预算调度器解决双向注意力与KV缓存不兼容问题，评估多种部署模式效果。",
  },
  {
    date: "2026-08-30",
