...
export const dailyPapers: DailyPaper[] = [
  ...
  },
  {
    ...
    titleZh: "一个精炼器解锁所有模型：通过强化查询精炼激发推理时推理能力",
    authors: "Anonymous et al.",
    arxivId: "2604.25444",
    tags: ["Reasoning", "Efficient Inference"],
    why: "A single RL-trained refiner rewrites queries at inference time to unlock better reasoning from frozen LLMs — no finetuning of the target model needed.",
    whyZh: "单一强化学习精炼器在推理时改写查询，激发冻结LLM更强推理能力，无需微调目标模型。",
    pick: true,
  },
  {
    date: "2026-09-06",
    ...
    why: "Token superposition overlaps representations during pre-training to cut compute cost — improved throughput without degrading model quality.",
    whyZh: "训练时叠加多个token表征，在不降低模型质量的前提下显著提升预训练计算效率。",
    pick: true,
  },
  {
    date: "2026-09-06",
  ...
  },
  {
    ...
    why: "Adapts pre-trained autoregressive models into encoder-decoder diffusion architecture — improves both training efficiency and generation speed for diffusion LMs.",
    whyZh: "将预训练自回归模型改造为编码器-解码器扩散架构，同步提升扩散LM训练效率和生成速度。",
  },
  {
    date: "2026-04-23",
