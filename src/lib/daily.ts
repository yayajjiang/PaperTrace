...
export const dailyPapers: DailyPaper[] = [
  ...
  },
  {
    ...
    titleZh: "经济思考：面向LLM自适应复杂度推理的层级框架",
    authors: "Yubo Gao et al.",
    arxivId: "2606.01168",
    tags: ["Reasoning", "Efficient Inference"],
    why: "Hierarchical framework adapts reasoning depth at problem and step granularities — cuts CoT token overhead without sacrificing accuracy on hard problems that need deep chains.",
    whyZh: "在问题级与步骤级双层自适应推理复杂度，减少CoT冗余token开销，同时保持需要深度推理的难题准确率。",
    pick: true,
  },
  {
    date: "2026-06-28",
