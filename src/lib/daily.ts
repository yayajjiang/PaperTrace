...
export const dailyPapers: DailyPaper[] = [
  {
    ...
    titleZh: "从边际到联合：扩散语言模型一步块生成的联合噪声蒸馏",
    authors: "Lin Yao",
    arxivId: "2609.06324",
    tags: ["Diffusion LM", "Efficient Inference"],
    why: "CONDOR uses coupled-noise distillation to train a student to generate a full block in one forward pass, without a target-side encoder or autoregressive teacher.",
    whyZh: "CONDOR 以联合噪声蒸馏训练学生模型单次前向生成完整 token 块，且不需要目标侧编码器或自回归教师。",
    pick: true,
  },
  {
    date: "2026-09-20",
    title: "Language Models Can Control Their Own Attention",
    titleZh: "语言模型能控制自身注意力范围",
    ...
    why: "Declarative Attention has the model emit global, focus, and local attention scopes; in zero-shot evaluation on 15 long-context tasks, the authors report fewer attended tokens with modest accuracy drops.",
    whyZh: "声明式注意力让模型输出全局、聚焦与局部注意力范围；作者在 15 个长上下文任务的零样本评估中报告，关注 token 更少且准确率仅有适度下降。",
    pick: true,
  },
  {
    date: "2026-09-20",
    title: "BASIS: Batchwise Advantage Estimation from Single-Rollout Information Sharing for LLM Reasoning",
    titleZh: "BASIS：单次 Rollout 批量信息共享的 LLM 推理优势估计",
    authors: "Shijin Gong, Erhan Xu, Kai Ye, Giulia Livieri, Francesco Quinzan, and Chengchun Shi",
    arxivId: "2605.27293",
    tags: ["Reasoning", "RLHF"],
    why: "BASIS shares information across prompts in a batch to estimate advantages from one rollout each; the authors report 69% lower MSE than REINFORCE++ in their experiments.",
    whyZh: "BASIS 在批次内跨提示共享信息，从每个提示的一次 rollout 估计优势；作者在实验中报告其 MSE 比 REINFORCE++ 低 69%。",
    pick: true,
  },
  {
    date: "2026-09-20",
    title: "Predict, Don't Iterate: Efficient Adaptive-Length Infilling for Diffusion Language Models",
    titleZh: "预测而非迭代：扩散语言模型高效自适应长度填充",
    authors: "Haobo Xu et al.",
    arxivId: "2609.02108",
    tags: ["Diffusion LM", "Efficient Inference"],
    why: "PILL predicts infill length from one mask-token hidden state, enabling variable-length infilling in fixed-length diffusion LMs in two passes; the authors report a 4.8-point code pass-rate gain and 1.82× speedup. EMNLP 2026 main conference.",
    whyZh: "PILL 从一个掩码 token 的隐藏状态预测填充长度，在两次前向传播中实现固定长度扩散语言模型的变长填充；作者报告代码通过率提高 4.8 个百分点、速度提升 1.82 倍。EMNLP 2026 主会论文。",
  },
  {
    date: "2026-09-20",
    title: "Routing by Reasoning Need: Trajectory-Aware Decoding Control for Diffusion Vision-Language Models",
    titleZh: "按推理需要路由：扩散视觉语言模型的轨迹感知解码控制",
    authors: "Yixiang Liu, Zhongxing Xu, Zhonghua Wang, and Xiaoying Tang",
    arxivId: "2609.11315",
    tags: ["Diffusion LM", "Multimodal"],
    why: "A training-free controller routes LLaDA-V queries among early, baseline, and reasoning-supportive decoding trajectories; the authors report improved robustness to task-dependent reasoning needs. Findings of EMNLP 2026.",
    whyZh: "一个免训练控制器将 LLaDA-V 查询路由至早提交、基线或推理支持型解码轨迹；作者报告其对任务依赖的推理需求更稳健。EMNLP 2026 Findings 论文。",
  },
  {
    date: "2026-09-20",
    title: "Coupled Calibration and Learning: Mitigating Teacher Bias in LLM Distillation without Target-Domain Reward Feedback",
    titleZh: "耦合校准与学习：免目标域奖励反馈的 LLM 蒸馏去偏",
    authors: "Haichen Hu, Yuheng Zhang, and David Simchi-Levi",
    arxivId: "2609.17474",
    tags: ["Fine-tuning"],
    why: "CCL calibrates a teacher using source-domain rewards before training a target-domain student. Under its stated framework, the paper proves that the student's KL divergence to an oracle in the student class converges to zero.",
    whyZh: "CCL 先用源域奖励校准教师，再训练目标域学生。在论文给定的框架下，作者证明学生与学生类中 oracle 的 KL 散度收敛至零。",
  },
  {
    date: "2026-09-13",
