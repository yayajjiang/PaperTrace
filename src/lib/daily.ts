...
export const dailyPapers: DailyPaper[] = [
  {
    ...
    titleZh: "LLM推理是潜在的，不是思维链",
    authors: "Wenshuo Wang",
    arxivId: "2604.15726",
    tags: ["Reasoning", "Theory"],
    why: "Position paper formalizes three hypotheses about reasoning: latent-state trajectory, surface CoT, or generic serial compute. Evidence favors latent-state H1 — challenges CoT faithfulness and interpretability claims.",
    whyZh: "建立推理三假说：潜在状态轨迹、表面CoT还是串行计算，现有证据支持潜在状态假说，挑战CoT忠实性与可解释性研究范式。",
    pick: true,
  },
  {
    date: "2026-05-03",
    title: "Too Correct to Learn: Reinforcement Learning on Saturated Reasoning Data",
    titleZh: "太对了反而学不了：RL在饱和推理数据上的困境",
    authors: "Zhenwen Liang et al.",
    arxivId: "2604.18493",
    tags: ["Reasoning", "RLHF"],
    why: "Identifies advantage signal collapse when strong base models saturate benchmarks — CUTS sampler enforces structured exploration, prevents mode collapse, and boosts out-of-domain generalization.",
    whyZh: "揭示强基础模型饱和基准时优势信号消失导致策略坍塌，CUTS采样器通过结构化探索突破瓶颈，提升域外泛化。",
    pick: true,
  },
  {
    date: "2026-05-03",
