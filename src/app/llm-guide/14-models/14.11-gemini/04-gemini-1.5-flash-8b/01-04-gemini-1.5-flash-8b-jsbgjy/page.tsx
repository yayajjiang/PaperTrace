...
export default function Page() {
  const { t } = useLang();
  const html = `<h1>Gemini 1.5 Flash-8B: 端侧与边缘计算的微型巨头 - 技术报告精译</h1>
<blockquote>
...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <LlmGuideNav currentRoute="14-models/14.11-gemini/04-gemini-1.5-flash-8b/01-04-gemini-1.5-flash-8b-jsbgjy" />
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <LlmGuideChapterBar currentRoute="14-models/14.11-gemini/04-gemini-1.5-flash-8b/01-04-gemini-1.5-flash-8b-jsbgjy" />
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight mb-2">Gemini 1.5 Flash-8B: 端侧与边缘计算的微型巨头 - 技术报告精译</h1>
