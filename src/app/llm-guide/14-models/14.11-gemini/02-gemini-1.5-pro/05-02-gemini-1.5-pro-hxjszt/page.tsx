...
export default function Page() {
  const { t } = useLang();
  const html = `<h1>02-Gemini-1.5-Pro 核心技术专题：原生多模态与长上下文的底层原理</h1>
<blockquote>
...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <LlmGuideNav currentRoute="14-models/14.11-gemini/02-gemini-1.5-pro/05-02-gemini-1.5-pro-hxjszt" />
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <LlmGuideChapterBar currentRoute="14-models/14.11-gemini/02-gemini-1.5-pro/05-02-gemini-1.5-pro-hxjszt" />
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight mb-2">02-Gemini-1.5-Pro 核心技术专题：原生多模态与长上下文的底层原理</h1>
