...
export default function Page() {
  const { t } = useLang();
  const html = `<h1>01-Gemini-1.0 核心技术专题：原生多模态与长上下文的底层原理</h1>
<blockquote>
...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <LlmGuideNav currentRoute="14-models/14.11-gemini/01-gemini-1.0/05-01-gemini-1.0-hxjszt" />
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <LlmGuideChapterBar currentRoute="14-models/14.11-gemini/01-gemini-1.0/05-01-gemini-1.0-hxjszt" />
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight mb-2">01-Gemini-1.0 核心技术专题：原生多模态与长上下文的底层原理</h1>
