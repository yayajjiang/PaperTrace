...
export default function Page() {
  const { t } = useLang();
  const html = `<h1>Project Astra: 实时视觉与语音多模态全双工 Agent - 技术报告精译</h1>
<blockquote>
...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <LlmGuideNav currentRoute="14-models/14.11-gemini/10-project-astra/01-10-project-astra-jsbgjy" />
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <LlmGuideChapterBar currentRoute="14-models/14.11-gemini/10-project-astra/01-10-project-astra-jsbgjy" />
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight mb-2">Project Astra: 实时视觉与语音多模态全双工 Agent - 技术报告精译</h1>
