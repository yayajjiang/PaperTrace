...
export default function Page() {
  const { t } = useLang();
  const html = `<h1>o1-preview: 纯强化学习驱动的 System-2 思考引擎 - 技术探测与反向工程</h1>
<blockquote>
...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <LlmGuideNav currentRoute="14-models/14.12-openai/11-o1-preview/01-11-o1-preview-fxgcjy" />
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <LlmGuideChapterBar currentRoute="14-models/14.12-openai/11-o1-preview/01-11-o1-preview-fxgcjy" />
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight mb-2">o1-preview: 纯强化学习驱动的 System-2 思考引擎 - 技术探测与反向工程</h1>
