...
export default function Page() {
  const { t } = useLang();
  const html = `<h1>ChatGPT (GPT-3.5): 引爆全球 AI 浪潮的对话引擎 - 技术探测与反向工程</h1>
<blockquote>
...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <LlmGuideNav currentRoute="14-models/14.12-openai/05-chat-gpt-3.5/01-05-chat-gpt-3.5-fxgcjy" />
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <LlmGuideChapterBar currentRoute="14-models/14.12-openai/05-chat-gpt-3.5/01-05-chat-gpt-3.5-fxgcjy" />
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight mb-2">ChatGPT (GPT-3.5): 引爆全球 AI 浪潮的对话引擎 - 技术探测与反向工程</h1>
