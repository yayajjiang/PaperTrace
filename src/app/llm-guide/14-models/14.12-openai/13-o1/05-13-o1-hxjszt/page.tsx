...
export default function Page() {
  const { t } = useLang();
  const html = `<h1>13-o1 核心技术专题：黑盒边界与逆向工程</h1>
<blockquote>
...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <LlmGuideNav currentRoute="14-models/14.12-openai/13-o1/05-13-o1-hxjszt" />
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <LlmGuideChapterBar currentRoute="14-models/14.12-openai/13-o1/05-13-o1-hxjszt" />
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight mb-2">13-o1 核心技术专题：黑盒边界与逆向工程</h1>
