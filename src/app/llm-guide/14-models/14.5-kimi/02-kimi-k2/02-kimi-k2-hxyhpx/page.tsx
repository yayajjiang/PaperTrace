...
export default function Page() {
  const { t } = useLang();
  const html = `<h1>Kimi-K2 核心演化剖析</h1>
<blockquote>
...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <LlmGuideNav currentRoute="14-models/14.5-kimi/02-kimi-k2/02-kimi-k2-hxyhpx" />
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <LlmGuideChapterBar currentRoute="14-models/14.5-kimi/02-kimi-k2/02-kimi-k2-hxyhpx" />
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight mb-2">Kimi-K2 核心演化剖析</h1>
