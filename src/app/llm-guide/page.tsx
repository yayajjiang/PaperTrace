    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <header className="mb-8">
          ...
          <p className="text-paper-800/50">{t("Chinese-language articles migrated from MetaBlog; article text is presented in its original language.", "从 MetaBlog 迁移的中文知识库，正文保留中文原文。")}</p>
        </header>
