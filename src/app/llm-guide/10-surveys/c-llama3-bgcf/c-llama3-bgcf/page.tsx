...
`;
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      <LlmGuideNav currentRoute="10-surveys/c-llama3-bgcf/c-llama3-bgcf" />
      <main className="flex-1 min-w-0 px-6 pt-20 pb-12 lg:pt-12">
        <LlmGuideChapterBar currentRoute="10-surveys/c-llama3-bgcf/c-llama3-bgcf" />
        <header className="mb-12">
          <h1 className="text-3xl font-bold tracking-tight mb-2">从Llama3报告出发</h1>
